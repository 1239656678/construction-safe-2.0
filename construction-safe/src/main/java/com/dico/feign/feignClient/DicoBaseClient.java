...
public interface DicoBaseClient {
    ...
    SysMenu getSysMenuByAreaId(@RequestParam(value = "areaId") String areaId);

    @GetMapping("/getSysMenuById")
    SysMenu getSysMenuById(@RequestParam(value = "id") String id);

    @PostMapping("/saveMenu")
    void saveMenuEntity(@RequestBody SysMenu sysMenu);
