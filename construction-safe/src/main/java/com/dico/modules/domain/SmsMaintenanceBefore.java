...
@NoArgsConstructor
@AllArgsConstructor
@ApiModel(value = "保养前信息实体")
@Table(name = "sms_maintenance_before", schema = "construction_safe", catalog = "")
public class SmsMaintenanceBefore {
    ...
    @ApiModelProperty(value = "保养描述", name = "remark", required = true)
