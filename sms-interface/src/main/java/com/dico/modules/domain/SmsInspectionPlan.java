...
public class SmsInspectionPlan {
    ...
    @ApiModelProperty(name = "planType", value = "计划类型", required = true)
    ...
    @Transient
    @ApiModelProperty(name = "itemIds", value = "绑定的ID字符串集合", example = "ID,ID,ID,ID")
    private String[] itemIds;

    @OneToMany(mappedBy = "smsInspectionPlan", cascade = CascadeType.ALL, fetch = FetchType.LAZY)
